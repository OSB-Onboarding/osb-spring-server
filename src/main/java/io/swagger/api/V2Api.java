...
public interface V2Api {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected", response = Error.class) })
    @RequestMapping(value = "/v2/service_instances/**/service_bindings/{binding_id}",
        produces = { "application/json" }, 
        consumes = { "application/json" },
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 412, message = "Precondition Failed", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected", response = Error.class) })
    @RequestMapping(value = "/v2/service_instances/**/service_bindings/{binding_id}/last_operation",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.GET)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 412, message = "Precondition Failed", response = Error.class),
        @ApiResponse(code = 200, message = "Unexpected", response = Error.class) })
    @RequestMapping(value = "/v2/service_instances/**/last_operation",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.GET)
